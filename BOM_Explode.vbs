...
fso.CopyFile "L:\akartasi\SAP_Scripts\BOM_Explode.xlsm", "L:\akartasi\SAP_Scripts\BOM_Explode" & "_" & strUserName & ".xlsm"
Set shl = CreateObject("WScript.Shell")
shl.Run """L:\akartasi\SAP_Scripts\BOM_Explode" & "_" & strUserName & ".xlsm"""
INPUT = InputBox("Podaj numer BOM", "BOM")
Set objExcel = GetObject( ,"Excel.Application") 
WorkbookName = "BOM_Explode" & "_" & strUserName & ".xlsm"
...
If INPUT <> "" Then
	...
	objExcel.Run WorkbookName & "!CopyFileData"
		...
		objExcel.Run "SaveAs"
		InfoBox = MsgBox ("Arkusz został zapisany na pulpicie pod nazwą: " + FileName + ".xlsx", vbOKOnly, "Zapis ukończony")
